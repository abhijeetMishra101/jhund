          ...
          <div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg px-4 py-4 flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">Connect a repository</div>
              </div>
              <button className="text-xs px-3 py-1.5 bg-gray-900 hover:bg-gray-800 text-white rounded-md transition-colors opacity-50 cursor-not-allowed">
                Connect
              </button>
            </div>
            <p className="text-xs text-gray-400 text-center mb-6">GitHub connection available after setup</p>
